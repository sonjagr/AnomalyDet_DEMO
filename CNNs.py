...
model_simple = tf.keras.Sequential([
    tf.keras.layers.InputLayer(input_shape=(160,160, 1)),
    tf.keras.layers.experimental.preprocessing.Rescaling(1. / 243.),
    #tf.keras.layers.RandomBrightness(factor = 0.2, value_range=(0, 243.), seed=None),
    tf.keras.layers.Conv2D(filters=64, kernel_size=(40,40), strides=(40,40), padding="valid",activation='relu'),
    tf.keras.layers.Dropout(0.2),
