...
The accuracy of the developed model was shown to me ~0.95. The accuracy is expected to increase if the model is trained further with new data. 
Images determined to be normal by the PS cab be removed and only those containing anomalies are saved for future use in re-training the model. 
