...
anomalous_labels = anomalous_db[[ 'orig_boxX', 'orig_boxY']].copy()
...
save_file(base_dir + dir_det + 'X_train_DET_final_cleaned2.npy', X_train_anomalous_list,  True)
save_file(base_dir + dir_det + 'X_test_DET_final_cleaned2.npy', X_test_anomalous_list, True)

save_file(base_dir + dir_det + 'Y_train_DET_final_cleaned2.npy', Y_train_anomalous_list, True)
save_file(base_dir + dir_det + 'Y_test_DET_final_cleaned2.npy', Y_test_anomalous_list,True)
